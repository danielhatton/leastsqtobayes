# This is file drawfromloglorentzian_ext.m
...
# log-Lorentzian distribution; if a Lorentzian is a suitable
# noninformative prior for a location parameter, it follows that the
# log-Lorentzian is a suitable noninformative prior for a scale
# parameter

addpath(fileparts(mfilename('fullpath'))) ;
output_precision(floor(-log(eps(1))/log(10))) ;
drawfromloglorentzian()
