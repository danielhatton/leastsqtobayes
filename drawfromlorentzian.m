# This is file drawfromlorentzian.m
...
# Its purpose is to return a single sample from a Lorentzian
...
function thesample = drawfromlorentzian()

  thesample = tan(pi*(rand()-1/2)) ;
