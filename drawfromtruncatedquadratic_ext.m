# This is file drawfromtruncatedquadratic_ext.m
...
# truncated quadratic distribution, which is suggested by
# Jeffreys:1961:TP as a noninformative prior for a parameter
# constrained to lie between lower and upper bounds

addpath(fileparts(mfilename('fullpath'))) ;
output_precision(floor(-log(eps(1))/log(10))) ;
drawfromtruncatedquadratic(str2num(argv(){1}),str2num(argv(){2}))
