...
# Its purpose is to return the probabilty density in a Gaussian
...
function probabilitydensity = gaussian(mean,stddev,x)

    probabilitydensity = exp(-((x-mean)/stddev)^2/2)/(sqrt(2)*stddev) ;
